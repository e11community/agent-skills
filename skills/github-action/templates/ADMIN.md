...
Copy to `docs/ADMIN.md`. One-time, org-admin tasks: creating the repo in the org and
protecting the default branch. Everything here uses the [`gh`](https://cli.github.com/) CLI.
Replace `ORG`/`REPO`/`DESC` with your values.
